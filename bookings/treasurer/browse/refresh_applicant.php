...
if ( $sendemail == 'yes') {
	...
	email_applicant(
	$recipient = $mainemail,
	$message = "<p>The payment details of your reservation for ".$college_event_title." have been changed. Please check below that you agree with the current details, if not please allow a day or so for further updates and if still incorrect <a href='mailto:treasurer@pembrokejuneevent.co.uk'>email the treasurer</a>.</p>".$applicantdetails,
