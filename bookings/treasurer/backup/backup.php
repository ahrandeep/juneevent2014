...
<?php
// DB already loaded in login.php

$datestamp = date("Y-m-d");      // Current date to append to filename of backup file in format of YYYY-MM-DD

/* CONFIGURE THE FOLLOWING SEVEN VARIABLES TO MATCH YOUR SETUP */
$dbuser  = $db_username;            // Database username
$dbpwd   = $db_password;            // Database password
$dbname  = $db_database;            // Database name. Use --all-databases if you have more than one
$filename= "backup-$datestamp.sql.gz";   // The name (and optionally path) of the dump file
$to      = "ahran@aujla.org";      // Email address to send dump file to
$from    = "noreply@pembrokejuneevent.co.uk";      // Email address message will show as coming from.
