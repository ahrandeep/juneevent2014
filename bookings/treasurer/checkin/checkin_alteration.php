...
for ($j = 0; $j < $numrows; ++$j) { 	
    ...
    $barcode   = get_post("barcode".$j);
	  ...
	  $query = "UPDATE ".$tablename." SET authorised='CHECKEDIN' WHERE id='".$id."'";
...
//<![CDATA[
 setTimeout("top.location.href = 'checkin.php'",300);
...
<?php
	...
	<div class="centerbox"> Guest checked-in successfully.</div>';
