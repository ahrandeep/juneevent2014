...
<div class="container">
  ...
  <?php
    ...
    if (crsid != "") {
      $query = 'SELECT COUNT(crsid) FROM workersapps WHERE crsid="'.$crsid.'" OR crsid="'.$crsid.'@cam.ac.uk"';
  ...
  <form class="form-horizontal" enctype="multipart/form-data" action="../../confirmation/workers.php" method="post"  role="form">
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        ...
        <div class="form-group col-xs-12 col-md-6">
          <label for="crsid" class="col-xs-4 control-label">Email*:</label>
          <div class="col-xs-8">
            <input type="text" class="form-control input-sm" id="crsid" name="crsid" <?php if ($crsid != '') echo 'disabled="disabled" value="'.$crsid.'@cam.ac.uk" '; ?>/>
          </div>
        </div>
        <div class="form-group col-xs-12 col-md-6"> 
