...
<div class="container">
  <div class="page-header">
    <h1>Reservation for <?php echo $college_event_title_year; ?></h1>
	  ...
	  if (!$opentopembroke) { bs_error_panel('Sorry, booking is not currently open.', true); }
	  if (!$opentoall && $applicanttype == "cam_member") { bs_error_panel('Sorry, booking is not currently open to general university members.', true); }
    ...
    if (!$waitingopen) {
	  ...
	  if ($pemcrsid == 1 || $applicanttype != 'pem_member') {
	      ...
	      require_once 'booking_form_new.php';
	  }
